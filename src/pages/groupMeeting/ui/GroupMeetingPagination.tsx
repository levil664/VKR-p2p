...
interface GroupMeetingPaginationProps {
  pageNumber: number;
  pageSize: number;
  totalPages: number;
  onPageChange: (event: React.ChangeEvent<unknown>, page: number) => void;
  onPageSizeChange: (event: SelectChangeEvent<unknown>) => void;
}

export const GroupMeetingPagination: React.FC<GroupMeetingPaginationProps> = ({
  pageNumber,
  pageSize,
  totalPages,
  onPageChange,
